...
struct Command commands[] =
{
		...
		{ "schedPRIRR", "Switch & initialize the scheduler to PRIORITY RR" ,command_schedPRIRR, 3},
...
int command_schedPRIRR(int number_of_arguments, char **arguments)
{
		...
		starvation_Threshold=strtol(arguments[3], NULL, 10);
		sched_init_PRIRR(numOfPriorities,quantum,starvation_Threshold);
	return 0;
}
